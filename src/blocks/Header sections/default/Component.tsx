...
const HeadersectionsComponent: React.FC = () => {
    return (
        <div>
            ...
            <div className="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-40">
                ...
                <div className="lg:mt-16">
                    ...
                    <h1
                        className="font-title text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl xl:text-7xl sm:tracking-tight">
...
export default HeadersectionsComponent;
