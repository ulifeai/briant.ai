...
const ContactsectionsComponent: React.FC = () => {
    return (
            ...
            <div className="relative mt-10 overflow-hidden bg-primary lg:mt-0 rounded-3xl -rotate-3">
              ...
              <div className="relative p-6 sm:px-8 sm:py-9">
                ...
                <blockquote className="mt-8">
                  ...
                  &quot;We love Landingfolio! Our designers were using it for their projects, so we already knew what kind
                    of
                    design they
                    want.&quot;
                  </p>
                ...
                <div className="flex items-center mt-6">
                  <img className="object-cover rounded-full w-11 h-11 shrink-0" src="/placeholder-image.svg"
                    alt=""/>
                  <div className="ml-4">
                ...
                <div>
                  ...
                  <div>
                    <input type="text" name="fullName" id="fullName" placeholder="Your name"
                      className="block w-full px-px py-4 text-base text-gray-900 placeholder-gray-600 bg-white border-b-2 focus:outline-none focus:border-primary focus:ring-0"/>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div>
                    <textarea name="email" id="email" placeholder="Write your message" rows={4}
                      className="block w-full px-px py-4 text-base text-gray-900 placeholder-gray-600 bg-white border-b-2 focus:outline-none focus:border-primary focus:ring-0"></textarea>
                  </div>
                </div>

                <button type="submit"
                  className="inline-flex items-center justify-center w-full px-12 py-4 text-base font-medium text-white transition-all duration-200 bg-primary border border-transparent rounded-xl hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-700">
                  Send message
                </button>
              </form>
            </div>
...
export default ContactsectionsComponent;
