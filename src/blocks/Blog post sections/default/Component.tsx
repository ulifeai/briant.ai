...
const BlogpostsectionsComponent: React.FC = () => {
    return (
         <section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
          <h2 className="font-title text-3xl font-bold text-gray-900 sm:text-4xl">
        ...
        <div
          className="grid max-w-2xl grid-cols-1 gap-4 mx-auto mt-12 sm:gap-6 xl:max-w-none xl:grid-cols-2 sm:mt-12 lg:gap-8 lg:mt-20">
          <div
...
export default BlogpostsectionsComponent;
