          ...
          <div className="grid grid-cols-1 lg:grid-cols-8 lg:gap-x-16 xl:gap-x-24 gap-y-12">
            <div className="lg:col-span-5 xl:pr-24">
              <div className="max-w-lg lg:max-w-none">
                ...
                <h2 className="font-title mt-6 text-3xl font-semibold tracking-tight text-gray-900 lg:mt-8 sm:text-4xl lg:text-5xl">
              ...
              <div
                className="grid grid-cols-1 pt-8 mt-8 border-t border-gray-200 sm:grid-cols-2 md:mt-16 xl:mt-24 gap-x-16 gap-y-8">
              ...
              <div className="mt-12">
                <a href="#" title=""
                  className="inline-flex items-center text-sm font-semibold text-primary transition-all duration-200 group hover:text-primary-800 hover:underline">
            ...
            <div className="lg:col-span-3">
              <img className="w-full xl:h-full xl:object-cover rounded-3xl" src="/placeholder-image.svg" alt="">
              </img>
            </div>
          </div>
        </div>
