...
const TestimonialsectionsComponent: React.FC = () => {
    return (
                    ...
                    <div className="lg:order-1">
                        ...
                        <blockquote className="mt-8">
                            ...
                            <p className="mt-8 text-lg font-normal leading-8 text-gray-600 sm:text-xl sm:leading-9">
                                “With Landingfolio, the design team can now build design which identifies employees&apos; career aspirations
                                and goals and
                                from which we approach managers and check to see what is happening.”
                            </p>
                        </blockquote>
...
export default TestimonialsectionsComponent;
