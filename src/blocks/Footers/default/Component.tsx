...
const FootersComponent: React.FC = () => {
    return (
        ...
        <div className="grid grid-cols-2 gap-12 mt-12 sm:grid-cols-3 lg:grid-cols-4 sm:mt-16 lg:mt-20">
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            ...
            <ul className="flex items-center mt-8 space-x-3">
              <li>
                <a href="#" title=""
                  className="inline-flex items-center justify-center w-8 h-8 text-gray-900 transition-all duration-200 border border-gray-200 rounded-full hover:border-primary hover:text-white hover:bg-primary"
          ...
          <div className="lg:pl-12">
            ...
            <ul className="mt-8 space-y-5">
              <li>
                <a href="#" title=""
                  className="inline-flex text-sm font-normal text-gray-600 transition-all duration-200 hover:translate-x-1 hover:text-gray-900">
                  About
                </a>
              </li>
