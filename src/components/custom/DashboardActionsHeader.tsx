...
export const DashboardActionsHeader = ({
  viewMode,
  setViewMode,
  pageid,
}: Props) => {
    ...
    <div className="bg-muted py-2 px-4 border-b border-border">
      <div className="flex items-center justify-between">
        <div className="flex">
          ...
          <Link
            data-canny-link
            target="Briantai.canny.io"
            href="https://briantai.featurebase.app"
          >
            <Button className="bg-primary mr-4" size="sm">
              <Sparkles className="h-4 w-4 mr-2" />
              Request feature
        ...
        <div className="flex items-center space-x-4">
          ...
          {pageid !== "" ? (
            <Link
              href={"/app/render/" + params.id + "/" + pageid}
              target="_blank"
            >
          ...
          <Link
            href={"/api/app/project/download/" + params.id}
            target="downloadPage"
          >
            <Button size="sm">
