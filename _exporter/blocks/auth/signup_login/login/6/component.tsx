        ...
        <div className='flex flex-col sm:flex-row'>
            ...
            <div className='w-full sm:w-1/2 relative px-[5%]'>
              <div className='flex flex-col gap-32 h-svh'>
                ...
                {/* ---------- footer ----------------- */}
                <div className='text-start text-sm h-16 fixed bottom-0 right-0 left-0 ps-[5%]'>
                 {footer_description}
                </div>
            ...
            <div className='sm:w-1/2 bg-[#eeeeee]  h-screen'>
                            ...
                            <CarouselItem className='flex flex-col items-center max-w-3xl gap-8'>
                                ...
                                <div className='flex items-center gap-4'>
                                    <div className='flex gap-4 items-center'>
                                        <Image src="/images/image.svg" alt='star' width={56} height={56} className='rounded-full'/>
                                        <div>
