...
export default function StackedListBlock({
  ...
  return (
    <div className="flex flex-col border-t-[1px] border-l-[1px] border-r-[1px] border-black">
      ...
      <div className="flex flex-col border-t-[1px] border-black">
        {cards.map((card, index) => (
          ...
          key={index}
            href={card.href}
            className="flex flex-col items-center border-b-[1px] border-black gap-y-4 px-6 py-4"
          >
