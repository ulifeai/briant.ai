    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container flex flex-col lg:grid lg:grid-cols-[1fr_1fr] gap-10 sm:gap-8">
        <div className="my-auto max-w-3xl flex flex-col gap-2 md:gap-6 lg:gap-5">
          <Text className="text-3xl font-bold md:text-6xl lg:text-7xl">
            {title}
          </Text>
        ...
        <div className="relative flex w-full gap-10">
          <div className="w-[45%] absolute top-auto bottom-[10%] left-0 right-auto">
            <img
          ...
          <div className="w-[40%] absolute top-[10%] bottom-auto left-auto right-0">
            <img
